...
# SOVA Protocol v1.0.1 - Installer for Linux/macOS
...
echo ""
echo -e "${RED}${BOLD}  !!! RESTART YOUR TERMINAL TO USE sova COMMANDS !!!${RESET}"
echo -e "${RED}${BOLD}  !!! PEREZAPUSTITE TERMINAL DLYA ISPOLZOVANIYA sova !!!${RESET}"
echo ""
log_info "Quick start (after terminal restart):"
echo "  sova                               # Interactive menu"
echo "  sova start                         # Start tunnel"
